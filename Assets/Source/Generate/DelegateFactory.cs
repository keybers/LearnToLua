...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(CustomDelegater), factory.CustomDelegater);
		dict.Add(typeof(CustomDelegaterref), factory.CustomDelegaterref);
		dict.Add(typeof(CustomCallParamsDelegater), factory.CustomCallParamsDelegater);
		...
		DelegateTraits<CustomDelegater>.Init(factory.CustomDelegater);
		DelegateTraits<CustomDelegaterref>.Init(factory.CustomDelegaterref);
		DelegateTraits<CustomCallParamsDelegater>.Init(factory.CustomCallParamsDelegater);
		...
		TypeTraits<CustomDelegater>.Init(factory.Check_CustomDelegater);
		TypeTraits<CustomDelegaterref>.Init(factory.Check_CustomDelegaterref);
		TypeTraits<CustomCallParamsDelegater>.Init(factory.Check_CustomCallParamsDelegater);
		...
		StackTraits<CustomDelegater>.Push = factory.Push_CustomDelegater;
		StackTraits<CustomDelegaterref>.Push = factory.Push_CustomDelegaterref;
		StackTraits<CustomCallParamsDelegater>.Push = factory.Push_CustomCallParamsDelegater;
	...
	class CustomDelegater_Event : LuaDelegate
	{
		public CustomDelegater_Event(LuaFunction func) : base(func) { }
		public CustomDelegater_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public CustomDelegater CustomDelegater(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			CustomDelegater fn = delegate(int param0, out int param1, out bool param2, out string param3, out int param4) 
			{
				param1 = 0;
				param2 = false;
				param3 = null;
		...
		if(!flag)
		{
			CustomDelegater_Event target = new CustomDelegater_Event(func);
			CustomDelegater d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			CustomDelegater_Event target = new CustomDelegater_Event(func, self);
			CustomDelegater d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_CustomDelegater(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(CustomDelegater), L, pos);
	}

	void Push_CustomDelegater(IntPtr L, CustomDelegater o)
	{
		ToLua.Push(L, o);
	}

	class CustomDelegaterref_Event : LuaDelegate
	{
		public CustomDelegaterref_Event(LuaFunction func) : base(func) { }
		public CustomDelegaterref_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public CustomDelegaterref CustomDelegaterref(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			CustomDelegaterref fn = delegate(int param0, ref int param1, ref bool param2, ref string param3, ref int param4) { return 0; };
			return fn;
		}

		if(!flag)
		{
			CustomDelegaterref_Event target = new CustomDelegaterref_Event(func);
			CustomDelegaterref d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			CustomDelegaterref_Event target = new CustomDelegaterref_Event(func, self);
			CustomDelegaterref d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_CustomDelegaterref(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(CustomDelegaterref), L, pos);
	}

	void Push_CustomDelegaterref(IntPtr L, CustomDelegaterref o)
	{
		ToLua.Push(L, o);
	}

	class CustomCallParamsDelegater_Event : LuaDelegate
	{
		public CustomCallParamsDelegater_Event(LuaFunction func) : base(func) { }
		public CustomCallParamsDelegater_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public CustomCallParamsDelegater CustomCallParamsDelegater(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			CustomCallParamsDelegater fn = delegate(int param0, object[] param1) { };
			return fn;
		}

		if(!flag)
		{
			CustomCallParamsDelegater_Event target = new CustomCallParamsDelegater_Event(func);
			CustomCallParamsDelegater d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			CustomCallParamsDelegater_Event target = new CustomCallParamsDelegater_Event(func, self);
			CustomCallParamsDelegater d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_CustomCallParamsDelegater(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(CustomCallParamsDelegater), L, pos);
	}

	void Push_CustomCallParamsDelegater(IntPtr L, CustomCallParamsDelegater o)
	{
		ToLua.Push(L, o);
	}
